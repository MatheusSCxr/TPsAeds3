 ...
 * disciplina:
 * - boolean create(ArvoreElemento objeto)   
 * - int[] read(ArvoreElemento objeto)
 * - boolean delete(ArvoreElemento objeto)
 * 
...
import models.RegistroArvoreBMais;
import models.SteamGame;

// Esta versão da árvore funciona apenas para chaves distintas

public class Index_ArvoreBMais<T extends RegistroArvoreBMais<T>> {
    ...
    public Index_ArvoreBMais(Constructor<T> c, int o, String na) throws Exception {
                ...
                while (database.getFilePointer() < database.length()){
                    try {
                        ...
                        if (lapide != 0xFF){
                            ...
                            arvore.create(new ArvoreElemento(jogo.getId(), endereco));
                        }
                        else{
